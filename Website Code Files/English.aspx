...
<body bgcolor="seashell">
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="SeaShell" Height="877px" Style="border-left-color: black;
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            <asp:Button ID="addingbut" runat="server" OnClick="addingbut_Click" Style="left: 158px;
                position: absolute; top: 5px" Text="Add New Ingredient" />
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Style="left: 7px;
            position: absolute; top: 5px" Text="View Ingredients" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <asp:Panel ID="Panel3" runat="server" Height="365px" Style="border-left-color: #000000;
            left: 305px; border-bottom-color: #000000; border-top-style: groove; border-top-color: #000000;
            border-right-style: groove; border-left-style: groove; position: absolute; top: 483px;
            ...
            <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Underline="True"
                Style="left: 87px; position: absolute; top: 23px" Text="Add New Ingredient"></asp:Label>
            <table style="left: 43px; width: 354px; position: absolute; top: 53px; height: 1px">
                <tr>
                    <td style="width: 193px; height: 13px">
                        <asp:Label ID="Label8" runat="server" Text="Ingredient Name in English"></asp:Label></td>
            ...
            &nbsp; <asp:RequiredFieldValidator 
             ...
             ControlToValidate="TextBox5" style="position: absolute">
                ...
                <tr>
                    <td style="width: 193px; height: 26px">
                        <asp:Label ID="Label18" runat="server" Text="Ingredient Name in Arabic"></asp:Label></td>
             ...
             ControlToValidate="TextBox4" style="position: absolute">
                ...
                <tr>
                    <td style="width: 193px; height: 27px">
                        <asp:Label ID="Label11" runat="server" Text="Health Disbenefits (English)"></asp:Label></td>
                    <td style="width: 173px; height: 27px">
             ...
             ControlToValidate="TextBox8" style="position: absolute">
                ...
                <tr>
                    <td style="width: 193px; height: 27px">
                        <asp:Label ID="Label22" runat="server" Text="Health Disbenefits (Arabic)"></asp:Label></td>
                    <td style="width: 173px; height: 27px">
      ...
      validationgroup="InfoGroup" runat="server" OnClick="Button1_Click" Text="Add" Height="30px" Width="100px" /></td>
        ...
        &nbsp; &nbsp;
        <table style="left: 305px; position: absolute; top: 153px; height: 230px" id="TABLE1" onclick="return TABLE1_onclick()">
            <tr>
                <td style="width: 141px; height: 21px">
                    <asp:Label ID="Label2" runat="server" Text="Ingredients:"></asp:Label></td>
            ...
            <tr>
                <td style="width: 141px">
                    <asp:Label ID="Label5" runat="server" Text="Units:"></asp:Label></td>
                <td style="width: 100px">
            ...
            <tr>
                <td style="width: 141px; height: 21px">
                    <asp:Label ID="Label12" runat="server" Text="Health Disbenefits:"></asp:Label></td>
                <td style="width: 100px; height: 21px">
        ...
        <asp:Image ID="Image1" runat="server" Height="143px" Style="left: 602px; position: absolute;
            top: 301px" Width="234px" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        <br />
        <br />
